...
<body>
  ...
  <main>
    <div style="width:160px; float:left;">
      <div id="nav">тут будемо вставляти календар з бронюванням</div>
    </div>
 ...
 <footer>
  <address>(с)Автор лабораторної роботи: студент спеціальності ПЗіС-24005м, Мошнін Микита Андрійович</address>
 </footer>
</body>
</html>